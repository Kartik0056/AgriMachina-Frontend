  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between items-center" style={{ flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <button onClick={fetchReviews} className="btn btn-secondary btn-sm" style={{ background: 'var(--admin-bg-card)', borderColor: 'var(--admin-border)', color: 'var(--admin-text-main)' }}>
      ...
      <div className="admin-card" style={{ padding: '0.75rem 1.25rem', display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
        <span style={{ fontSize: '0.85rem', color: 'var(--admin-text-muted)', fontWeight: 600 }}>Moderation Queue:</span>
          ...
          return (
            <button
              ...
              style={{
                ...
                color: isActive ? '#ffffff' : 'var(--admin-text-main, #cbd5e1)',
      ...
      <div className="flex flex-col gap-4">
        {loading ? (
          ...
          <div className="admin-card" style={{ textAlign: 'center', padding: '3rem', color: 'var(--admin-text-muted)' }}>
            <MessageSquare size={36} color="var(--admin-border, #64748b)" style={{ margin: '0 auto 0.75rem auto' }} />
            ...
            >
              <div className="flex items-center justify-between" style={{ flexWrap: 'wrap', gap: '0.75rem' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div style={{ fontWeight: 700, color: 'var(--admin-text-main)', fontSize: '0.95rem' }}>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {rev.title && (
                    <strong style={{ color: 'var(--admin-text-main)', fontSize: '0.95rem' }}>{rev.title}</strong>
                  )}
                </div>
                <p style={{ color: 'var(--admin-text-muted)', fontSize: '0.9rem', lineHeight: 1.5, marginTop: '0.35rem' }}>
                  "{rev.comment}"
                </p>
              ...
              {/* Actions Strip */}
              <div className="flex justify-end gap-2" style={{ borderTop: '1px solid var(--admin-border, #1e2e4f)', paddingTop: '0.75rem' }}>
                {rev.status !== 'Approved' && (
                  <button
                    type="button"
                ...
                {rev.status !== 'Rejected' && (
                  <button
                    ...
                    style={{ background: 'var(--admin-bg-card-alt)', borderColor: 'var(--admin-border)', color: '#fca5a5', display: 'flex', alignItems: 'center', gap: '0.35rem' }}
                  >
                    <X size={14} />
                    <span>Reject</span>
                  </button>
                ...
                <button
                  ...
                  className="btn btn-secondary btn-sm"
                  style={{ background: 'var(--admin-bg-card-alt)', borderColor: 'var(--admin-border)', color: '#ef4444' }}
                >
                  <Trash2 size={14} />
                </button>
              </div>
