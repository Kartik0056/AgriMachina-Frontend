...
const AdminProductEditorPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    features: [],
    applications: [],
    idealFor: ['General Use'],
    compatibility: { compatibleAttachments: [], compatibleBrands: [] },
    whatsIncluded: ['Product Base Unit', 'User Guide'],
    ...
    warranty: { period: '1 Year Manufacturer Warranty', type: 'Standard Warranty', provider: 'OEM Pan-India Network', terms: 'Covers manufacturer defects and workmanship.' },
